...
student = dict(
        init_cfg=dict(
            type='Pretrained',
            checkpoint="/home/user/sun_chen/Projects/KDTFA/weights/split_2/tfa_random_init_bbox_head.pth"
        ),
...
evaluation = dict(interval=2000, metric='mAP',save_best='mAP',class_splits=['BASE_CLASSES_SPLIT2', 'NOVEL_CLASSES_SPLIT2'])
